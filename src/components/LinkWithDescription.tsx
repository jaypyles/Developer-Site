...
const LinkWithDescription: React.FC<LinkWithDescriptionProps> = ({
  ...
  return (
    <div className="flex flex-col text-base bg-[#c0c0c0] mb-[1em] emboss">
      <div className="flex flex-row justify-between align-middle text-ellipsis">
        <a href={link} className="link text-[90%] !ml-[0.5em] mt-[0.25em]">
          {link}
        </a>
        {github && (
          <a
      ...
      <p className="description text-[80%] ml-[0.5em] mb-[0.5em] w-3/4 leading-tight mt-1 max-md:mt-2">
        {small_description}
      </p>
    </div>
  );
