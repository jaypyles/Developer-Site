export const routes = [
  { path: "/games", to: "https://howlongtobeat.com/user/jpyles" },
  { path: "/anime", to: "https://myanimelist.net/profile/jpyles" },
  {
    path: "/spotify",
  ...
  {
    path: "/resume",
    to: "https://drive.google.com/file/d/1hOu51LQc63LlrFWnSMxv8-VYvfbmeoUs/view?usp=sharing",
  },
];
